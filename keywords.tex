...
\textit{irest} & \textbf{0} & Controls the restart of the simulation. \\
 & & \textbf{0} -- Do not restart. \\
 & & If "restart.xyz" file is present, end with and error for safety reasons. \\
...
(Previously called "\&nhcopt", which is still supported for backwards compatibility reasons)
...
\textit{temp0} & -- &  Temperature of initial Maxwell-Boltzmann distribution. \\
